...
public class MaterialMenuActivity extends AppCompatActivity implements DialogInterface.OnDismissListener{
    ...
    private void launchPowerMenu(View v) {
        ...
        FabAnimationUtils.scaleOut(fabPower, new FabAnimationUtils.ScaleCallback() {
            ...
            public void onAnimationEnd() {
                fabPower.setImageResource(R.mipmap.close);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                FabAnimationUtils.scaleOut(fabPower, new FabAnimationUtils.ScaleCallback() {
                    ...
                    @Override
                    public void onAnimationEnd() {
                        fabPower.setImageResource(R.mipmap.power);
                        FabAnimationUtils.scaleIn(fabPower);
                    }
                });
            }
